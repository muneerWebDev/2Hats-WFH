...
function vertex_footer_copyright() {
	...
	return '&copy; ' . date_i18n( __( 'Y', 'vertex' ) ) .'. '. __('Powered by <a href="https://dessign.net/best-free-wordpress-themes/" target="_blank">WordPress</a>. Vertex <a href="https://dessign.net/" target="_blank">Dessign</a>','vertex');
