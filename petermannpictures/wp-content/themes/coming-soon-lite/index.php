...
<div class="container">
	...
	<?php else : ?>
		<header class="page-header">
			<h2 class="page-title"><?php esc_html_e( 'Posts', 'coming-soon-lite' ); ?></h2>
		</header>
	<?php endif; ?>
	...
	<div class="content-area">
		<main id="main" class="site-main" role="main">
			<?php
			    $layout_option = get_theme_mod( 'coming_soon_lite_theme_options',__( 'Right Sidebar','coming-soon-lite') );
