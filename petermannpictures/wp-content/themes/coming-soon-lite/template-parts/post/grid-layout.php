...
<div class="col-lg-4 col-md-4">
    ...
    <div class="article_content">
      <div class="metabox"> 
        ...
        <span class="entry-comments"><a href="<?php echo esc_url( get_permalink() );?>"><i class="fas fa-comments"></i><?php comments_number( __('0 Comments','coming-soon-lite'), __('0 Comments','coming-soon-lite'), __('% Comments','coming-soon-lite') ); ?></a></span>
      </div>
